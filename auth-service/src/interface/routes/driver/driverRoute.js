...
driverRouter.post("/login", async (req, res, next) =>
  controllers.driverLogincontroller.login(req, res, next)
);

driverRouter.get("/refreshToken", async (req, res, next) =>
  controllers.refreshTokenController.refreshUserToken(req, res, next)
);
...
driverRouter.get("/logout", AuthHandler.isDriverLogin, async (req, res, next) =>
  controllers.driverLogoutcontroller.logout(req, res, next)
);

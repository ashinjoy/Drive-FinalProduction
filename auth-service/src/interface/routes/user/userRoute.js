...
userRouter.put(
  ...
  async (req, res, next) =>
    controllers.updateUserDataController.updateUserDetails(req, res, next)
);
userRouter.post(
  "/save-contacts",
  AuthHandler.isUserLogin,
  async (req, res, next) =>
    controllers.saveContactsController.saveContacts(req, res, next)
);
userRouter.get("/logout", AuthHandler.isUserLogin, async (req, res, next) =>
  controllers.logoutController.userLogout(req, res, next)
);
